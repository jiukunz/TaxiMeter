...
public class XianStartupPriceProvider implements StartupPriceProvider {
    private static final LocalTime TWENTY_TWO = new LocalTime(22, 0);
    private static final LocalTime SIX = new LocalTime(6, 0);
    private static final int DAY_STARTUP_PRICE = 6;
    private static final int MIDNIGHT_STARTUP_PRICE = 7;
